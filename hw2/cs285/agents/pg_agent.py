...
class PGAgent(nn.Module):
    ...
    def _estimate_advantage(
        ...
        if self.critic is None:
            # No baseline: advantages are just the Q-values
            advantages = q_values
        else:
            ...
            if self.gae_lambda is None:
                # Without GAE: subtract baseline from Q-values
        ...
        # Normalize the advantages to have mean zero and std one within the batch
